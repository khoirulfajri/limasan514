...
Route::get('/cek-kamar', [BookingController::class, 'cekKamar']);
...
Route::prefix('admin')->name('admin.')->middleware('admin')->group(function () {
    ...
    Route::get('/booking/form', [AdminController::class, 'formBooking'])->name('booking.form');
    Route::get('/booking/form/{id}', [AdminController::class, 'formBooking'])->name('booking.form.edit');
